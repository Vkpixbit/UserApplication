...
public class OwnerRentalAddInList extends AndroidGlobalData {
	...
	@Test(dataProvider = "rental_add_owner_data", enabled = true)
	...
	@DataProvider
	public Object[][] rental_add_owner_data() throws IOException {
		List<HashMap<String, String>> value = getjsondata(
				System.getProperty("user.dir") + "/src/test/java/com/pixbit/appium/test/data/rental/RentData.json");
